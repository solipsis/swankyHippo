  ...
  t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.state = function (t) {
    var i,
      ...
      var n,
          ...
          n.verbose("Initializing module"), f.automatic && n.add.defaults(), f.context && "" !== s ? e(f.context).on(s, "mouseenter" + m, n.change.text).on(s, "mouseleave" + m, n.reset.text).on(s, "click" + m, n.toggle.state) : y.on("mouseenter" + m, n.change.text).on("mouseleave" + m, n.reset.text).on("click" + m, n.toggle.state), n.instantiate();
        }, instantiate: function instantiate() {
          n.verbose("Storing instance of module", n), C = n, y.data(T, n);
        }, destroy: function destroy() {
          n.verbose("Destroying previous module", C), y.off(m).removeData(T);
          ...
          n.verbose("Syncing other buttons to current state"), n.is.active() ? o.not(y).state("activate") : o.not(y).state("deactivate");
            ...
            var e = p.active || y.data(g.storedText),
                t = p.inactive || y.data(g.storedText);n.is.textEnabled() && (n.is.active() && e ? (n.verbose("Resetting active text", e), n.update.text(e)) : t && (n.verbose("Resetting inactive text", e), n.update.text(t)));
          } }, update: { text: function text(e) {
            var t = n.get.text();e && e !== t ? (n.debug("Updating text", e), f.selector.text ? y.data(g.storedText, e).find(f.selector.text).text(e) : y.data(g.storedText, e).html(e)) : n.debug("Text is already set, ignoring update", e);
          } }, setting: function setting(t, i) {
          if (n.debug("Changing setting", t, i), e.isPlainObject(t)) e.extend(!0, f, t);else {
            if (i === a) return f[t];e.isPlainObject(f[t]) ? e.extend(!0, f[t], i) : f[t] = i;
          }
          ...
          f.silent || (n.error = Function.prototype.bind.call(console.error, console, f.name + ":"), n.error.apply(console, arguments));
            ...
            var t, a, i;f.performance && (t = new Date().getTime(), i = c || t, a = t - i, c = t, r.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: w, "Execution Time": a })), clearTimeout(n.performance.timer), n.performance.timer = setTimeout(n.performance.display, 500);
          }, display: function display() {
            var t = f.name + ":",
                i = 0;c = !1, clearTimeout(n.performance.timer), e.each(r, function (e, t) {
              i += t["Execution Time"];
          ...
          var c,
              r,
              l,
              u = C;return o = o || d, s = w || s, "string" == typeof t && u !== a && (t = t.split(/[\. ]/), c = t.length - 1, e.each(t, function (i, o) {
            var s = i != c ? o + t[i + 1].charAt(0).toUpperCase() + t[i + 1].slice(1) : t;if (e.isPlainObject(u[s]) && i != c) u = u[s];else {
              if (u[s] !== a) return r = u[s], !1;if (!e.isPlainObject(u[o]) || i == c) return u[o] !== a ? (r = u[o], !1) : (n.error(v.method, t), !1);u = u[o];
            }
          })), e.isFunction(r) ? l = r.apply(s, o) : r !== a && (l = r), e.isArray(i) ? i.push(l) : i !== a ? i = [i, l] : l !== a && (i = l), r;
