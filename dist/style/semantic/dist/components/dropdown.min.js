...
!function (e, t, n, i) {
  ...
  t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.dropdown = function (a) {
    var o,
        ...
        v = arguments[0],
        m = "string" == typeof v,
        h = [].slice.call(arguments, 1);return s.each(function (f) {
      var g,
          p,
          b,
          w,
          ...
          G = !1,
          J = this,
          X = P.data(M);y = { initialize: function initialize() {
          ...
          y.verbose("Storing instance of dropdown", y), X = y, P.data(M, y);
        }, destroy: function destroy() {
          y.verbose("Destroying previous dropdown", P), y.remove.tabbable(), P.off(F).removeData(M), W.off(F), r.off(w), y.disconnect.menuObserver(), y.disconnect.selectObserver();
        }, observeChanges: function observeChanges() {
          "MutationObserver" in t && (S = new MutationObserver(y.event.select.mutation), C = new MutationObserver(y.event.menu.mutation), y.debug("Setting up mutation observer", S, C), y.observe.select(), y.observe.menu());
        }, disconnect: { menuObserver: function menuObserver() {
            C && C.disconnect();
          }, selectObserver: function selectObserver() {
            S && S.disconnect();
          } }, observe: { select: function select() {
            y.has.input() && S.observe(U[0], { childList: !0, subtree: !0 });
          }, menu: function menu() {
          ...
          e = e !== i ? e : y.get.query(), y.verbose("Searching for query", e), y.has.minCharacters(e) ? y.filter(e) : y.hide();
            ...
            e = e.eq(0);var t = e.nextAll(O.item).not(O.unselectable).eq(0),
                ...
                i = t.length > 0;i ? (y.verbose("Moving selection to", t), t.addClass(T.selected)) : (y.verbose("Moving selection to", n), n.addClass(T.selected));
          } }, setup: { api: function api() {
            var e = { debug: A.debug, urlData: { value: y.get.value(), query: y.get.query() }, on: !1 };y.verbose("First request, initializing API"), P.api(e);
            ...
            var e = s.slice(0, f),
                t = s.slice(f + 1);s = e.add(P).add(t);
          } }, refresh: function refresh() {
          y.refreshSelectors(), y.refreshData();
        }, refreshItems: function refreshItems() {
          $ = W.find(O.item);
        }, refreshSelectors: function refreshSelectors() {
          y.verbose("Refreshing selector cache"), H = P.find(O.text), j = P.find(O.search), U = P.find(O.input), K = P.find(O.icon), B = P.prev().find(O.text).length > 0 ? P.prev().find(O.text) : P.prev(), W = P.children(O.menu), $ = W.find(O.item);
          ...
          if (t = e.isFunction(t) ? t : function () {}, !y.can.show() && y.is.remote() && (y.debug("No API results retrieved, searching before show"), y.queryRemote(y.get.query(), y.show)), y.can.show() && !y.is.active()) {
            if (y.debug("Showing dropdown"), !y.has.message() || y.has.maxSelections() || y.has.allResultsFiltered() || y.remove.message(), y.is.allFiltered()) return !0;A.onShow.call(J) !== !1 && y.animate.show(function () {
          ...
          var e = W.children(O.item).find(O.menu);y.verbose("Hiding sub menus", e), e.transition("hide");
        }, bind: { events: function events() {
            c && y.bind.touchEvents(), y.bind.keyboardEvents(), y.bind.inputEvents(), y.bind.mouseEvents();
          }, touchEvents: function touchEvents() {
            y.debug("Touch device detected binding additional touch events"), y.is.searchSelection() || y.is.single() && P.on("touchstart" + F, y.event.test.toggle), W.on("touchstart" + F, O.item, y.event.item.mouseenter);
          }, keyboardEvents: function keyboardEvents() {
            y.verbose("Binding keyboard events"), P.on("keydown" + F, y.event.keydown), y.has.search() && P.on(y.get.inputEvent() + F, O.search, y.event.input), y.is.multiple() && r.on("keydown" + w, y.event.document.keydown);
          }, inputEvents: function inputEvents() {
            y.verbose("Binding input change events"), P.on("change" + F, O.input, y.event.change);
          }, mouseEvents: function mouseEvents() {
            y.verbose("Binding mouse events"), y.is.multiple() && P.on("click" + F, O.label, y.event.label.click).on("click" + F, O.remove, y.event.remove.click), y.is.searchSelection() ? (P.on("mousedown" + F, y.event.mousedown).on("mouseup" + F, y.event.mouseup).on("mousedown" + F, O.menu, y.event.menu.mousedown).on("mouseup" + F, O.menu, y.event.menu.mouseup).on("click" + F, O.icon, y.event.icon.click).on("focus" + F, O.search, y.event.search.focus).on("click" + F, O.search, y.event.search.focus).on("blur" + F, O.search, y.event.search.blur).on("click" + F, O.text, y.event.text.focus), y.is.multiple() && P.on("click" + F, y.event.click)) : ("click" == A.on ? P.on("click" + F, O.icon, y.event.icon.click).on("click" + F, y.event.test.toggle) : "hover" == A.on ? P.on("mouseenter" + F, y.delay.show).on("mouseleave" + F, y.delay.hide) : P.on(A.on + F, y.toggle), P.on("mousedown" + F, y.event.mousedown).on("mouseup" + F, y.event.mouseup).on("focus" + F, y.event.focus), y.has.menuSearch() ? P.on("blur" + F, O.search, y.event.search.blur) : P.on("blur" + F, y.event.blur)), W.on("mouseenter" + F, O.item, y.event.item.mouseenter).on("mouseleave" + F, O.item, y.event.item.mouseleave).on("click" + F, O.item, y.event.item.click);
          ...
          var n = t !== i ? t : y.get.query(),
            ...
            var t,
              ...
              if (t = String(y.get.choiceText(o, !1)), -1 !== t.search(s)) return a.push(this), !0;if ("exact" === A.fullTextSearch && y.exactSearch(n, t)) return a.push(this), !0;if (A.fullTextSearch === !0 && y.fuzzySearch(n, t)) return a.push(this), !0;
            }if ("both" == A.match || "value" == A.match) {
              if (i = String(y.get.choiceValue(o, t)), -1 !== i.search(s)) return a.push(this), !0;if ("exact" === A.fullTextSearch && y.exactSearch(n, i)) return a.push(this), !0;if (A.fullTextSearch === !0 && y.fuzzySearch(n, i)) return a.push(this), !0;
            }
          ...
          y.has.search() && !y.is.focusedOnSearch() && (e ? (P.off("focus" + F, O.search), j.focus(), P.on("focus" + F, O.search, y.event.search.focus)) : j.focus());
        }, forceSelection: function forceSelection() {
          var e = $.not(T.filtered).filter("." + T.selected).eq(0),
              t = $.not(T.filtered).filter("." + T.active).eq(0),
              n = e.length > 0 ? e : t,
              i = n.length > 0;return i && !y.is.multiple() ? (y.debug("Forcing partial selection to selected item", n), void y.event.item.click.call(n, {}, !0)) : void (A.allowAdditions ? (y.set.selected(y.get.query()), y.remove.searchTerm()) : y.remove.searchTerm());
            ...
            var n = e(t.target);n.is(P) && (y.is.focusedOnSearch() ? y.show() : y.focusSearch());
          }, search: { focus: function focus() {
              Q = !0, y.is.multiple() && y.remove.activeLabel(), A.showOnFocus && y.search();
            }, blur: function blur(e) {
              p = n.activeElement === this, y.is.searchSelection() && !b && (Y || p || (A.forceSelection && y.forceSelection(), y.hide())), b = !1;
            ...
            (y.is.multiple() || y.is.searchSelection()) && y.set.filtered(), clearTimeout(y.timer), y.timer = setTimeout(y.search, A.delay.search);
              ...
              var n = e(t.target),
                  ...
                  s = a.length > 0,
                  r = a.find(n).length > 0;!r && s && (clearTimeout(y.itemTimer), y.itemTimer = setTimeout(function () {
            ...
            var t = e.which,
              ...
              var i,
                  a,
                  o = $.not(O.unselectable).filter("." + T.selected).eq(0),
                  ...
                  g = A.allowAdditions && A.hideAdditions && (t == I.enter || f) && h;if (g && (y.verbose("Selecting item from keyboard shortcut", r), y.event.item.click.call(r, e), y.is.searchSelection() && y.remove.searchTerm()), y.is.visible()) {
            ...
            var a = e(t.target),
                ...
                s = a.closest(P).length > 0;return i = e.isFunction(i) ? i : function () {}, o && !s ? (y.verbose("Triggering event", i), i(), !0) : (y.verbose("Event occurred in dropdown, canceling callback"), !1);
          }, eventOnElement: function eventOnElement(t, i) {
            var a = e(t.target),
                o = a.closest(O.siblingLabel),
                s = n.body.contains(t.target),
                r = 0 === P.find(o).length,
                l = 0 === a.closest(W).length;return i = e.isFunction(i) ? i : function () {}, s && r && l ? (y.verbose("Triggering event", i), i(), !0) : (y.verbose("Event occurred in dropdown menu, canceling callback"), !1);
            ...
            if (n = n !== i ? n : t, y.can.activate(e(a))) {
              if (y.set.value(n, e(a)), y.is.multiple() && !y.is.allFiltered()) return;y.hideAndClear();
            }
            ...
            var t,
                n = y.get.values();return t = y.is.multiple() ? e.isArray(n) ? n.length : 0 : "" !== y.get.value() ? 1 : 0;
            ...
            var e,
                t,
                i = j.get(0);return "selectionStart" in i ? i.selectionStart : n.selection ? (i.focus(), e = n.selection.createRange(), t = e.text.length, e.moveStart("character", -i.value.length), e.text.length - t) : void 0;
            ...
            var e = j[0];return e ? e.oninput !== i ? "input" : e.onpropertychange !== i ? "propertychange" : "keyup" : !1;
            ...
            var a,
                o,
                s = !1;return t = t !== i ? t : y.get.values() !== i ? y.get.values() : y.get.text(), a = o ? t.length > 0 : t !== i && null !== t, o = y.is.multiple() && e.isArray(t), n = "" === t || 0 === t ? !0 : n || !1, a && $.each(function () {
              var a = e(this),
                  r = y.get.choiceText(a),
            ...
            var e = y.get.defaultText(),
                t = y.get.placeholderText;e === t ? (y.debug("Restoring default placeholder text", e), y.set.placeholderText(e)) : (y.debug("Restoring default text", e), y.set.text(e));
          }, placeholderText: function placeholderText() {
            ...
            var n;return t.Storage === i ? void y.error(V.noStorage) : (n = sessionStorage.getItem(e), n !== i ? n : !1);
          } }, save: { defaults: function defaults() {
            y.save.defaultText(), y.save.placeholderText(), y.save.defaultValue();
          }, defaultValue: function defaultValue() {
            var e = y.get.value();y.verbose("Saving default value as", e), P.data(D.defaultValue, e);
          }, defaultText: function defaultText() {
            var e = y.get.text();y.verbose("Saving default text as", e), P.data(D.defaultText, e);
          }, placeholderText: function placeholderText() {
            var e;A.placeholder !== !1 && H.hasClass(T.placeholder) && (e = y.get.text(), y.verbose("Saving placeholder text as", e), P.data(D.placeholderText, e));
          ...
          var n,
              ...
              v = $.not(O.unselectable);a = "up" == e ? v.index(o) - u : v.index(o) + u, n = "up" == e ? a >= 0 : a < v.length, i = n ? v.eq(a) : "up" == e ? v.first() : v.last(), i.length > 0 && (y.debug("Scrolling page", e, i), o.removeClass(T.selected), i.addClass(T.selected), A.selectOnKeydown && y.is.single() && y.set.selectedItem(i), s.scrollTop(d));
            ...
            y.is.searchSelection() ? (y.debug("Added tabindex to searchable dropdown"), j.val("").attr("tabindex", 0), W.attr("tabindex", -1)) : (y.debug("Added tabindex to dropdown"), P.attr("tabindex") === i && (P.attr("tabindex", 0), W.attr("tabindex", -1)));
            ...
            var n,
                ...
                u,
                d,
                v = 5;e = e || y.get.selectedItem(), n = e.closest(O.menu), a = e && e.length > 0, t = t !== i ? t : !1, e && n.length > 0 && a && (s = e.position().top, n.addClass(T.loading), l = n.scrollTop(), r = n.offset().top, s = e.offset().top, o = l - r + s, t || (c = n.height(), d = o + v > l + c, u = l > o - v), y.debug("Scrolling to active item", o), (t || u || d) && n.scrollTop(o), n.removeClass(T.loading));
            ...
            var n,
                ...
                o = !1;a && (n = i.nextAll($).eq(0), y.has.firstLetter(n, t) && (o = n)), o || $.each(function () {
            ...
            var a = y.escape.value(e),
              ...
              if (!A.allowReselection && r == s && (y.verbose("Skipping value update already same value", e, s), !y.is.initialLoad())) return;y.is.single() && y.has.selectInput() && y.can.extendSelect() && (y.debug("Adding user option", e), y.add.optionValue(e)), y.debug("Updating input value", a, s), G = !0, U.val(a), A.fireOnInit === !1 && y.is.initialLoad() ? y.debug("Input native change event ignored on initial load") : y.trigger.change(), G = !1;
            } else y.verbose("Storing value in metadata", a, U), a !== s && P.data(D.value, r);A.fireOnInit === !1 && y.is.initialLoad() ? y.verbose("No callback on initial load", A.onChange) : A.onChange.call(J, e, t, n);
            ...
            var i = y.is.multiple();n = A.allowAdditions ? n || y.get.itemWithAdditions(t) : n || y.get.item(t), n && (y.debug("Setting selected menu item to", n), y.is.multiple() && y.remove.searchWidth(), y.is.single() ? (y.remove.activeItem(), y.remove.selectedItem()) : A.useLabels && y.remove.selectedItem(), n.each(function () {
              var t = e(this),
            ...
            var a,
                ...
                s = y.escape.value(t);return a = e("<a />").addClass(T.label).attr("data-" + D.value, s).html(E.label(s, n)), a = A.onLabelCreate.call(a, s, n), y.has.label(t) ? void y.debug("Label already exists, skipping", s) : (A.label.variation && a.addClass(A.label.variation), void (i === !0 ? (y.debug("Animating in label", a), a.addClass(T.hidden).insertBefore(o).transition(A.label.transition, A.label.duration)) : (y.debug("Adding selection label", a), a.insertBefore(o))));
          }, message: function message(t) {
            var n = W.children(O.message),
                i = A.templates.message(y.add.variables(t));n.length > 0 ? n.html(i) : n = e("<div/>").html(i).addClass(T.message).appendTo(W);
          }, optionValue: function optionValue(t) {
            var n = y.escape.value(t),
                i = U.find('option[value="' + y.escape.string(n) + '"]'),
                a = i.length > 0;a || (y.disconnect.selectObserver(), y.is.single() && (y.verbose("Removing previous user addition"), U.find("option." + T.addition).remove()), e("<option/>").prop("value", n).addClass(T.addition).html(t).appendTo(U), y.verbose("Adding user addition as an <option>", t), y.observe.select());
          }, userSuggestion: function userSuggestion(e) {
            var t,
                n = W.children(O.addition),
                i = y.get.item(e),
                a = i && i.not(O.addition).length,
                o = n.length > 0;if (!A.useLabels || !y.has.maxSelections()) {
              if ("" === e || a) return void n.remove();o ? (n.data(D.value, e).data(D.text, e).attr("data-" + D.value, e).attr("data-" + D.text, e).removeClass(T.filtered), A.hideAdditions || (t = A.templates.addition(y.add.variables(k.addResult, e)), n.html(t)), y.verbose("Replacing user suggestion with new value", n)) : (n = y.create.userChoice(e), n.prependTo(W), y.verbose("Adding item choice to menu corresponding with user choice addition", n)), A.hideAdditions && !y.is.allFiltered() || n.addClass(T.selected).siblings().removeClass(T.selected), y.refreshItems();
            }
            ...
            var t = y.escape.value(e),
                n = U.find('option[value="' + y.escape.string(t) + '"]'),
                i = n.length > 0;i && n.hasClass(T.addition) && (S && (S.disconnect(), y.verbose("Temporarily disconnecting mutation observer")), n.remove(), y.verbose("Removing user addition as an <option>", t), S && S.observe(U[0], { childList: !0, subtree: !0 }));
            ...
            var n = P.find(O.label),
                i = n.filter("[data-" + D.value + '="' + y.escape.string(e) + '"]');y.verbose("Removing label", i), i.remove();
            ...
            t = t || P.find(O.label), y.verbose("Removing labels", t), t.each(function () {
              var t = e(this),
                  n = t.data(D.value),
                  a = n !== i ? String(n) : n,
                  o = y.is.userValue(a);return A.onLabelRemove.call(t, n) === !1 ? void y.debug("Label remove callback cancelled removal") : (y.remove.message(), void (o ? (y.remove.value(a), y.remove.label(a)) : y.remove.selected(a)));
            });
          }, tabbable: function tabbable() {
            y.is.searchSelection() ? (y.debug("Searchable dropdown initialized"), j.removeAttr("tabindex"), W.removeAttr("tabindex")) : (y.debug("Simple selection dropdown initialized"), P.removeAttr("tabindex"), W.removeAttr("tabindex"));
            ...
            var n, i;return e && 0 !== e.length && "string" == typeof t ? (n = y.get.choiceText(e, !1), t = t.toLowerCase(), i = String(n).charAt(0).toLowerCase(), t == i) : !1;
            ...
            var t = y.escape.value(e),
                n = P.find(O.label);return n.filter("[data-" + D.value + '="' + y.escape.string(t) + '"]').length > 0;
            ...
            var t,
                n = e || W,
                i = !0,
                a = {};return n.addClass(T.loading), t = { context: { scrollTop: z.scrollTop(), height: z.outerHeight() }, menu: { offset: n.offset(), height: n.outerHeight() } }, y.is.verticallyScrollableContext() && (t.menu.offset.top += t.context.scrollTop), a = { above: t.context.scrollTop <= t.menu.offset.top - t.menu.height, below: t.context.scrollTop + t.context.height >= t.menu.offset.top + t.menu.height }, a.below ? (y.verbose("Dropdown can fit in context downward", a), i = !0) : a.below || a.above ? (y.verbose("Dropdown cannot fit below, opening upward", a), i = !1) : (y.verbose("Dropdown cannot fit in either direction, favoring downward", a), i = !0), n.removeClass(T.loading), i;
            ...
            var e = z.get(0) !== t ? z.css("overflow-y") : !1;return "auto" == e || "scroll" == e;
          } }, can: { activate: function activate(e) {
            return A.useLabels ? !0 : y.has.maxSelections() ? !(!y.has.maxSelections() || !e.hasClass(T.active)) : !0;
          ...
          A.silent || (y.error = Function.prototype.bind.call(console.error, console, A.name + ":"), y.error.apply(console, arguments));
            ...
            var t, n, i;A.performance && (t = new Date().getTime(), i = u || t, n = t - i, u = t, d.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: J, "Execution Time": n })), clearTimeout(y.performance.timer), y.performance.timer = setTimeout(y.performance.display, 500);
          ...
          var s,
              r,
              l,
              c = X;return n = n || h, a = J || a, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function (n, a) {
